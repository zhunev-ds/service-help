...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.aiisDocumentationUpdate.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.aiis-documentation-updates.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('actual_metr_data') ? 'is-invalid' : '' }}" name="actual_metr_data" id="actual_metr_data">{{ old('actual_metr_data') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('mapping') ? 'is-invalid' : '' }}" name="mapping" id="mapping">{{ old('mapping') }}</textarea>
