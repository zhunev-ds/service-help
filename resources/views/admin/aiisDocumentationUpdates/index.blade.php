...
@section('content')
@can('aiis_documentation_update_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.aiis-documentation-updates.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.aiisDocumentationUpdate.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.aiisDocumentationUpdate.title_singular') }} {{ trans('global.list') }}
    </div>
