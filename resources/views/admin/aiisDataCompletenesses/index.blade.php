...
@section('content')
@can('aiis_data_completeness_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.aiis-data-completenesses.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.aiisDataCompleteness.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.aiisDataCompleteness.title_singular') }} {{ trans('global.list') }}
    </div>
